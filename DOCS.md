...
| [catalog/analytics-calls-api-draft.yaml](catalog/analytics-calls-api-draft.yaml) | **Draft** OpenAPI for analytics calls list/detail + HTTP tool span summaries (`MK-01-ANALYTICS-VERTICAL`); live routes: [api/routes/analytics.py](api/routes/analytics.py) |
