...
| **Next pass (suggested)** | Regenerate hosted voice previews with ElevenLabs (`ELEVENLABS_API_KEY` + [generate_catalog_voice_preview_audio.py](scripts/generate_catalog_voice_preview_audio.py)); optional **`billing_api_base_url`** auto-wire for telecom payment redirect. |
