...
| **Next pass (suggested)** | Staff one **roadmap motion** per vertical (graph + runbook happy path + analytics proof) or pick next epic from [READMEPLANNING.md](READMEPLANNING.md) §6. |
