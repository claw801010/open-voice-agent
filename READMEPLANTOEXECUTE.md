...
| **Next pass (suggested)** | **WE-01-DATASTORE-INTEG (optional):** cache-hit counters on **`/usage`** or analytics insights. **WE-01-VISUAL-DEPTH:** extend **`ovo-*`** to **`/overview`** / **`/reports`**. Push local commits when ready. |
