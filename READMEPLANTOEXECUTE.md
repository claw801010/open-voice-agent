...
|--------------------------------|-------|-------|
| **MK-01-SHIP-PR** (`Done`) | _TBD_ | Pushed **`feat/mk01-local-all-in-one-gtm`** — [PR #1](https://github.com/claw801010/open-voice-agent/pull/1) ready for merge. |
...
| **Next pass (suggested)** | **Merge [PR #1](https://github.com/claw801010/open-voice-agent/pull/1)**. **`Incomplete`:** **MK-01-VOICE-SPOKEN** (`ELEVENLABS_API_KEY=… ./scripts/regen_catalog_voice_previews.sh`). **Offline gate:** `./scripts/verify_mk01_buyer_shipped.sh`. |
