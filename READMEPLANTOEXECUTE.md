...
| **Next pass (suggested)** | **MK-01 depth** — preview audio / try-flow polish, or eighth vertical (telecom / utilities). |
...
| 2026-05-25 | **MK-01-PREBUILD (SMB CRM lead capture)** — **`lead_capture_complex`** + [smb-franchise-lead-capture-complex.json](catalog/packaged-workflows/smb-franchise-lead-capture-complex.json); all **seven** vertical packs have empty **`roadmap_motions`**. |
