...
| **Next pass (suggested)** | **MK-01 depth** — hosted **`preview_audio_url`** assets (ElevenLabs batch samples per vertical); ninth vertical (public sector / gov) per [READMEPLANNING.md](READMEPLANNING.md) §6. |
