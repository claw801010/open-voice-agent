...
| **Next pass (suggested)** | **MK-01 depth** — fourth vertical row or expanded try-flows; **WE-01** polish; see [prebuild-vertical-demo-matrix.md](catalog/recipes/prebuild-vertical-demo-matrix.md). |
...
**Next pass:** **MK-01-PREBUILD-COMPLETE** — **`Done`**. **MK-01 depth:** fourth vertical or expanded GTM try-flows. **WE-01-DATASTORE-INTEG (optional):** per-integration cache metrics drill-down. **WE-01-VISUAL-DEPTH:** **`/overview`** / **`/reports`** rollout.
