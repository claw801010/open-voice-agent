...
| **Next pass (suggested)** | **Insurance PREBUILD** — quote qual or claims lookup complex variants; or fifth vertical row; see [PREBUILD_VERTICAL_ROADMAP.md](catalog/PREBUILD_VERTICAL_ROADMAP.md). |
