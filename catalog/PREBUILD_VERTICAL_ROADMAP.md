...
**Next engineering slice (when staffed):** **Seventh vertical row** ([READMEPLANNING.md](../READMEPLANNING.md) §6 SMB) or **MK-01 depth** (preview audio / try-flow polish); use [prebuild-vertical-demo-matrix.md](recipes/prebuild-vertical-demo-matrix.md) for GTM demos.
