...
**Import adapters spike (MK-01-IMPORT-OPTIONS):** worksheet [IMPORT_ADAPTERS_SPIKE.md](IMPORT_ADAPTERS_SPIKE.md) — owner, first target, security notes before importer code lands.
