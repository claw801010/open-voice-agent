...
- `POST /api/v1/appointments`, `/api/v1/appointments/reschedule`, `/api/v1/offers/attach`, `/api/v1/payment-promises`, `/api/v1/quotes/intent`, `/api/v1/accounts/health`, `/api/v1/deals/stage`, `/api/v1/visits/enroll`, `/book_slot`, `/book_demo`, … → **201** with [booking-scheduling-upstream-response.sample.json](../fixtures/booking-scheduling-upstream-response.sample.json)
