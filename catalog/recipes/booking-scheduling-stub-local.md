...
- `POST /api/v1/appointments`, `/api/v1/appointments/reschedule`, `/api/v1/offers/attach`, `/api/v1/accounts/health`, `/book_slot`, `/book_demo`, … → **201** with [booking-scheduling-upstream-response.sample.json](../fixtures/booking-scheduling-upstream-response.sample.json)
