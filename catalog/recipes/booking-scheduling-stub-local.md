...
- `POST /api/v1/appointments`, `/book_slot`, `/book_demo`, … → **201** with [booking-scheduling-upstream-response.sample.json](../fixtures/booking-scheduling-upstream-response.sample.json)
