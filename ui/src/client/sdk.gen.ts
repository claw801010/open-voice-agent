 ...
 */
export const getAnalyticsInsightsApiV1AnalyticsInsightsGet = <ThrowOnError extends boolean = false>(options?: Options<GetAnalyticsInsightsApiV1AnalyticsInsightsGetData, ThrowOnError>) => (options?.client ?? client).get<GetAnalyticsInsightsApiV1AnalyticsInsightsGetResponses, GetAnalyticsInsightsApiV1AnalyticsInsightsGetErrors, ThrowOnError>({ url: '/api/v1/analytics/insights', ...options });

/**
 * List Analytics Calls
 */
export const listAnalyticsCallsApiV1AnalyticsCallsGet = <ThrowOnError extends boolean = false>(options?: Options<ListAnalyticsCallsApiV1AnalyticsCallsGetData, ThrowOnError>) => (options?.client ?? client).get<ListAnalyticsCallsApiV1AnalyticsCallsGetResponses, ListAnalyticsCallsApiV1AnalyticsCallsGetErrors, ThrowOnError>({ url: '/api/v1/analytics/calls', ...options });

/**
 * Export Analytics Calls Csv
 *
 ...
 */
export const exportAnalyticsCallsCsvApiV1AnalyticsCallsExportGet = <ThrowOnError extends boolean = false>(options?: Options<ExportAnalyticsCallsCsvApiV1AnalyticsCallsExportGetData, ThrowOnError>) => (options?.client ?? client).get<ExportAnalyticsCallsCsvApiV1AnalyticsCallsExportGetResponses, ExportAnalyticsCallsCsvApiV1AnalyticsCallsExportGetErrors, ThrowOnError>({ url: '/api/v1/analytics/calls/export', ...options });

/**
 * Get Analytics Qm Scorecard
 *
 * Org QM rubric used to render pass/fail scorecard on call detail.
 */
export const getAnalyticsQmScorecardApiV1AnalyticsQmScorecardGet = <ThrowOnError extends boolean = false>(options?: Options<GetAnalyticsQmScorecardApiV1AnalyticsQmScorecardGetData, ThrowOnError>) => (options?.client ?? client).get<GetAnalyticsQmScorecardApiV1AnalyticsQmScorecardGetResponses, GetAnalyticsQmScorecardApiV1AnalyticsQmScorecardGetErrors, ThrowOnError>({ url: '/api/v1/analytics/qm-scorecard', ...options });

/**
 * Put Analytics Qm Scorecard
 */
export const putAnalyticsQmScorecardApiV1AnalyticsQmScorecardPut = <ThrowOnError extends boolean = false>(options: Options<PutAnalyticsQmScorecardApiV1AnalyticsQmScorecardPutData, ThrowOnError>) => (options.client ?? client).put<PutAnalyticsQmScorecardApiV1AnalyticsQmScorecardPutResponses, PutAnalyticsQmScorecardApiV1AnalyticsQmScorecardPutErrors, ThrowOnError>({
 ...
 */
export const getAnalyticsDashboardLayoutApiV1AnalyticsDashboardLayoutGet = <ThrowOnError extends boolean = false>(options?: Options<GetAnalyticsDashboardLayoutApiV1AnalyticsDashboardLayoutGetData, ThrowOnError>) => (options?.client ?? client).get<GetAnalyticsDashboardLayoutApiV1AnalyticsDashboardLayoutGetResponses, GetAnalyticsDashboardLayoutApiV1AnalyticsDashboardLayoutGetErrors, ThrowOnError>({ url: '/api/v1/analytics/dashboard-layout', ...options });

/**
 * Put Analytics Dashboard Layout
 *
 * Replace org Overview dashboard layout (validated; same shape as browser localStorage draft).
 */
export const putAnalyticsDashboardLayoutApiV1AnalyticsDashboardLayoutPut = <ThrowOnError extends boolean = false>(options: Options<PutAnalyticsDashboardLayoutApiV1AnalyticsDashboardLayoutPutData, ThrowOnError>) => (options.client ?? client).put<PutAnalyticsDashboardLayoutApiV1AnalyticsDashboardLayoutPutResponses, PutAnalyticsDashboardLayoutApiV1AnalyticsDashboardLayoutPutErrors, ThrowOnError>({
...
/**
 * Get Analytics Redaction Policy
 *
 * Org-level toggle for analytics PII redaction (detail + server CSV). Default: enabled.
 */
export const getAnalyticsRedactionPolicyApiV1AnalyticsRedactionPolicyGet = <ThrowOnError extends boolean = false>(options?: Options<GetAnalyticsRedactionPolicyApiV1AnalyticsRedactionPolicyGetData, ThrowOnError>) => (options?.client ?? client).get<GetAnalyticsRedactionPolicyApiV1AnalyticsRedactionPolicyGetResponses, GetAnalyticsRedactionPolicyApiV1AnalyticsRedactionPolicyGetErrors, ThrowOnError>({ url: '/api/v1/analytics/redaction-policy', ...options });

/**
 * Put Analytics Redaction Policy
 *
 * Replace org analytics redaction policy (enterprise / QM — disabling exposes more raw fields).
 */
export const putAnalyticsRedactionPolicyApiV1AnalyticsRedactionPolicyPut = <ThrowOnError extends boolean = false>(options: Options<PutAnalyticsRedactionPolicyApiV1AnalyticsRedactionPolicyPutData, ThrowOnError>) => (options.client ?? client).put<PutAnalyticsRedactionPolicyApiV1AnalyticsRedactionPolicyPutResponses, PutAnalyticsRedactionPolicyApiV1AnalyticsRedactionPolicyPutErrors, ThrowOnError>({
...
/**
 * Get Analytics Qm Export Schedule
 *
 * Org schedule for automated QM CSV uploads to object storage (same columns as server export).
 */
export const getAnalyticsQmExportScheduleApiV1AnalyticsQmExportScheduleGet = <ThrowOnError extends boolean = false>(options?: Options<GetAnalyticsQmExportScheduleApiV1AnalyticsQmExportScheduleGetData, ThrowOnError>) => (options?.client ?? client).get<GetAnalyticsQmExportScheduleApiV1AnalyticsQmExportScheduleGetResponses, GetAnalyticsQmExportScheduleApiV1AnalyticsQmExportScheduleGetErrors, ThrowOnError>({ url: '/api/v1/analytics/qm-export-schedule', ...options });

/**
 * Put Analytics Qm Export Schedule
 *
 * Replace QM export schedule (worker must run with ENABLE_ANALYTICS_QM_EXPORT_CRON for hourly runs).
 */
export const putAnalyticsQmExportScheduleApiV1AnalyticsQmExportSchedulePut = <ThrowOnError extends boolean = false>(options: Options<PutAnalyticsQmExportScheduleApiV1AnalyticsQmExportSchedulePutData, ThrowOnError>) => (options.client ?? client).put<PutAnalyticsQmExportScheduleApiV1AnalyticsQmExportSchedulePutResponses, PutAnalyticsQmExportScheduleApiV1AnalyticsQmExportSchedulePutErrors, ThrowOnError>({
...
/**
 * Generate Call Ai Review Route
 */
export const generateCallAiReviewRouteApiV1AnalyticsCallsCallIdAiReviewPost = <ThrowOnError extends boolean = false>(options: Options<GenerateCallAiReviewRouteApiV1AnalyticsCallsCallIdAiReviewPostData, ThrowOnError>) => (options.client ?? client).post<GenerateCallAiReviewRouteApiV1AnalyticsCallsCallIdAiReviewPostResponses, GenerateCallAiReviewRouteApiV1AnalyticsCallsCallIdAiReviewPostErrors, ThrowOnError>({
...
/**
 * List Call Follow Ups
 */
export const listCallFollowUpsApiV1AnalyticsCallsCallIdFollowUpsGet = <ThrowOnError extends boolean = false>(options: Options<ListCallFollowUpsApiV1AnalyticsCallsCallIdFollowUpsGetData, ThrowOnError>) => (options.client ?? client).get<ListCallFollowUpsApiV1AnalyticsCallsCallIdFollowUpsGetResponses, ListCallFollowUpsApiV1AnalyticsCallsCallIdFollowUpsGetErrors, ThrowOnError>({ url: '/api/v1/analytics/calls/{call_id}/follow-ups', ...options });

/**
 * Create Call Follow Up
 */
export const createCallFollowUpApiV1AnalyticsCallsCallIdFollowUpsPost = <ThrowOnError extends boolean = false>(options: Options<CreateCallFollowUpApiV1AnalyticsCallsCallIdFollowUpsPostData, ThrowOnError>) => (options.client ?? client).post<CreateCallFollowUpApiV1AnalyticsCallsCallIdFollowUpsPostResponses, CreateCallFollowUpApiV1AnalyticsCallsCallIdFollowUpsPostErrors, ThrowOnError>({
...
/**
 * Apply Workflow Improvement Route
 */
export const applyWorkflowImprovementRouteApiV1AnalyticsCallsCallIdApplyWorkflowImprovementPost = <ThrowOnError extends boolean = false>(options: Options<ApplyWorkflowImprovementRouteApiV1AnalyticsCallsCallIdApplyWorkflowImprovementPostData, ThrowOnError>) => (options.client ?? client).post<ApplyWorkflowImprovementRouteApiV1AnalyticsCallsCallIdApplyWorkflowImprovementPostResponses, ApplyWorkflowImprovementRouteApiV1AnalyticsCallsCallIdApplyWorkflowImprovementPostErrors, ThrowOnError>({
 ...
 * Get Analytics Call
 */
export const getAnalyticsCallApiV1AnalyticsCallsCallIdGet = <ThrowOnError extends boolean = false>(options: Options<GetAnalyticsCallApiV1AnalyticsCallsCallIdGetData, ThrowOnError>) => (options.client ?? client).get<GetAnalyticsCallApiV1AnalyticsCallsCallIdGetResponses, GetAnalyticsCallApiV1AnalyticsCallsCallIdGetErrors, ThrowOnError>({ url: '/api/v1/analytics/calls/{call_id}', ...options });
 ...
 */
export const submitProductFeedbackApiV1FeedbackPost = <ThrowOnError extends boolean = false>(options: Options<SubmitProductFeedbackApiV1FeedbackPostData, ThrowOnError>) => (options.client ?? client).post<SubmitProductFeedbackApiV1FeedbackPostResponses, SubmitProductFeedbackApiV1FeedbackPostErrors, ThrowOnError>({
    url: '/api/v1/feedback',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
/**
 * Get Vertical Packs Catalog
 *
 * Return canonical `catalog/vertical-packs.json` from the repo (same file as docs).
 */
export const getVerticalPacksCatalogApiV1CatalogVerticalPacksGet = <ThrowOnError extends boolean = false>(options?: Options<GetVerticalPacksCatalogApiV1CatalogVerticalPacksGetData, ThrowOnError>) => (options?.client ?? client).get<GetVerticalPacksCatalogApiV1CatalogVerticalPacksGetResponses, GetVerticalPacksCatalogApiV1CatalogVerticalPacksGetErrors, ThrowOnError>({ url: '/api/v1/catalog/vertical-packs', ...options });
 ...
 */
export const importN8nPackagedDraftApiV1WorkflowImportN8nPackagedDraftPost = <ThrowOnError extends boolean = false>(options: Options<ImportN8nPackagedDraftApiV1WorkflowImportN8nPackagedDraftPostData, ThrowOnError>) => (options.client ?? client).post<ImportN8nPackagedDraftApiV1WorkflowImportN8nPackagedDraftPostResponses, ImportN8nPackagedDraftApiV1WorkflowImportN8nPackagedDraftPostErrors, ThrowOnError>({
...
/**
 * Import N8N And Create Workflow
 *
 ...
 */
export const importN8nAndCreateWorkflowApiV1WorkflowImportN8nAndCreatePost = <ThrowOnError extends boolean = false>(options: Options<ImportN8nAndCreateWorkflowApiV1WorkflowImportN8nAndCreatePostData, ThrowOnError>) => (options.client ?? client).post<ImportN8nAndCreateWorkflowApiV1WorkflowImportN8nAndCreatePostResponses, ImportN8nAndCreateWorkflowApiV1WorkflowImportN8nAndCreatePostErrors, ThrowOnError>({
...
/**
 * Import Make Packaged Draft
 *
 * Convert a Make scenario blueprint into a Dograh packaged-style workflow_definition.
 */
export const importMakePackagedDraftApiV1WorkflowImportMakePackagedDraftPost = <ThrowOnError extends boolean = false>(options: Options<ImportMakePackagedDraftApiV1WorkflowImportMakePackagedDraftPostData, ThrowOnError>) => (options.client ?? client).post<ImportMakePackagedDraftApiV1WorkflowImportMakePackagedDraftPostResponses, ImportMakePackagedDraftApiV1WorkflowImportMakePackagedDraftPostErrors, ThrowOnError>({
...
/**
 * Import Make And Create Workflow
 *
 * Convert a Make blueprint and create a workflow in the caller's org.
 */
export const importMakeAndCreateWorkflowApiV1WorkflowImportMakeAndCreatePost = <ThrowOnError extends boolean = false>(options: Options<ImportMakeAndCreateWorkflowApiV1WorkflowImportMakeAndCreatePostData, ThrowOnError>) => (options.client ?? client).post<ImportMakeAndCreateWorkflowApiV1WorkflowImportMakeAndCreatePostResponses, ImportMakeAndCreateWorkflowApiV1WorkflowImportMakeAndCreatePostErrors, ThrowOnError>({
...
/**
 * Import Zapier Packaged Draft
 *
 * Convert a Zapier import-subset export into a packaged-style workflow_definition.
 */
export const importZapierPackagedDraftApiV1WorkflowImportZapierPackagedDraftPost = <ThrowOnError extends boolean = false>(options: Options<ImportZapierPackagedDraftApiV1WorkflowImportZapierPackagedDraftPostData, ThrowOnError>) => (options.client ?? client).post<ImportZapierPackagedDraftApiV1WorkflowImportZapierPackagedDraftPostResponses, ImportZapierPackagedDraftApiV1WorkflowImportZapierPackagedDraftPostErrors, ThrowOnError>({
...
/**
 * Import Zapier And Create Workflow
 *
 * Convert a Zapier export and create a workflow in the caller's org.
 */
export const importZapierAndCreateWorkflowApiV1WorkflowImportZapierAndCreatePost = <ThrowOnError extends boolean = false>(options: Options<ImportZapierAndCreateWorkflowApiV1WorkflowImportZapierAndCreatePostData, ThrowOnError>) => (options.client ?? client).post<ImportZapierAndCreateWorkflowApiV1WorkflowImportZapierAndCreatePostResponses, ImportZapierAndCreateWorkflowApiV1WorkflowImportZapierAndCreatePostErrors, ThrowOnError>({
...
/**
 * Import Skill Packaged Draft
 *
 * Distill agent skill markdown into a packaged-style workflow_definition.
 */
export const importSkillPackagedDraftApiV1WorkflowImportSkillPackagedDraftPost = <ThrowOnError extends boolean = false>(options: Options<ImportSkillPackagedDraftApiV1WorkflowImportSkillPackagedDraftPostData, ThrowOnError>) => (options.client ?? client).post<ImportSkillPackagedDraftApiV1WorkflowImportSkillPackagedDraftPostResponses, ImportSkillPackagedDraftApiV1WorkflowImportSkillPackagedDraftPostErrors, ThrowOnError>({
...
/**
 * Import Skill And Create Workflow
 *
 * Distill skill markdown and create a workflow in the caller's org.
 */
export const importSkillAndCreateWorkflowApiV1WorkflowImportSkillAndCreatePost = <ThrowOnError extends boolean = false>(options: Options<ImportSkillAndCreateWorkflowApiV1WorkflowImportSkillAndCreatePostData, ThrowOnError>) => (options.client ?? client).post<ImportSkillAndCreateWorkflowApiV1WorkflowImportSkillAndCreatePostResponses, ImportSkillAndCreateWorkflowApiV1WorkflowImportSkillAndCreatePostErrors, ThrowOnError>({
...
/**
 * Get Workflow Weekly Usage Rollup
 *
 * Server-side UTC week aggregates for a single workflow (org-scoped).
 */
export const getWorkflowWeeklyUsageRollupApiV1WorkflowWorkflowIdUsageWeeklyRollupGet = <ThrowOnError extends boolean = false>(options: Options<GetWorkflowWeeklyUsageRollupApiV1WorkflowWorkflowIdUsageWeeklyRollupGetData, ThrowOnError>) => (options.client ?? client).get<GetWorkflowWeeklyUsageRollupApiV1WorkflowWorkflowIdUsageWeeklyRollupGetResponses, GetWorkflowWeeklyUsageRollupApiV1WorkflowWorkflowIdUsageWeeklyRollupGetErrors, ThrowOnError>({ url: '/api/v1/workflow/{workflow_id}/usage/weekly-rollup', ...options });

/**
 * Get Workflow Daily Usage Rollup
 *
 * Server-side UTC **day** aggregates for a single workflow (org-scoped).
 */
export const getWorkflowDailyUsageRollupApiV1WorkflowWorkflowIdUsageDailyRollupGet = <ThrowOnError extends boolean = false>(options: Options<GetWorkflowDailyUsageRollupApiV1WorkflowWorkflowIdUsageDailyRollupGetData, ThrowOnError>) => (options.client ?? client).get<GetWorkflowDailyUsageRollupApiV1WorkflowWorkflowIdUsageDailyRollupGetResponses, GetWorkflowDailyUsageRollupApiV1WorkflowWorkflowIdUsageDailyRollupGetErrors, ThrowOnError>({ url: '/api/v1/workflow/{workflow_id}/usage/daily-rollup', ...options });
...
/**
 * Install Workflow From Catalog
 *
 * Create a workflow in the caller's org from a catalog pack (packaged graph + defaults).
 */
export const installWorkflowFromCatalogApiV1WorkflowInstallFromCatalogPost = <ThrowOnError extends boolean = false>(options: Options<InstallWorkflowFromCatalogApiV1WorkflowInstallFromCatalogPostData, ThrowOnError>) => (options.client ?? client).post<InstallWorkflowFromCatalogApiV1WorkflowInstallFromCatalogPostResponses, InstallWorkflowFromCatalogApiV1WorkflowInstallFromCatalogPostErrors, ThrowOnError>({
...
/**
 * Heuristic cost and Dograh token estimate (dry-run)
 *
 * Rough pricing from draft (or released) graph + user model settings; not a live meter reading.
 */
export const workflowEstimateCostApiV1WorkflowWorkflowIdEstimateCostGet = <ThrowOnError extends boolean = false>(options: Options<WorkflowEstimateCostApiV1WorkflowWorkflowIdEstimateCostGetData, ThrowOnError>) => (options.client ?? client).get<WorkflowEstimateCostApiV1WorkflowWorkflowIdEstimateCostGetResponses, WorkflowEstimateCostApiV1WorkflowWorkflowIdEstimateCostGetErrors, ThrowOnError>({ url: '/api/v1/workflow/{workflow_id}/estimate-cost', ...options });

/**
 * Text-only LLM turn using draft graph (editor simulation)
 *
 * Run one chat turn against the first Agent after Start — uses org LLM keys; no PSTN.
 */
export const workflowSimulationTextTurnApiV1WorkflowWorkflowIdSimulationTextTurnPost = <ThrowOnError extends boolean = false>(options: Options<WorkflowSimulationTextTurnApiV1WorkflowWorkflowIdSimulationTextTurnPostData, ThrowOnError>) => (options.client ?? client).post<WorkflowSimulationTextTurnApiV1WorkflowWorkflowIdSimulationTextTurnPostResponses, WorkflowSimulationTextTurnApiV1WorkflowWorkflowIdSimulationTextTurnPostErrors, ThrowOnError>({
 ...
 */
export const testHttpCallApiV1ToolsTestHttpCallPost = <ThrowOnError extends boolean = false>(options: Options<TestHttpCallApiV1ToolsTestHttpCallPostData, ThrowOnError>) => (options.client ?? client).post<TestHttpCallApiV1ToolsTestHttpCallPostResponses, TestHttpCallApiV1ToolsTestHttpCallPostErrors, ThrowOnError>({
...
/**
 * Get Http Integration Cache Policy
 *
 ...
 */
export const getHttpIntegrationCachePolicyApiV1OrganizationsHttpIntegrationCachePolicyGet = <ThrowOnError extends boolean = false>(options?: Options<GetHttpIntegrationCachePolicyApiV1OrganizationsHttpIntegrationCachePolicyGetData, ThrowOnError>) => (options?.client ?? client).get<GetHttpIntegrationCachePolicyApiV1OrganizationsHttpIntegrationCachePolicyGetResponses, GetHttpIntegrationCachePolicyApiV1OrganizationsHttpIntegrationCachePolicyGetErrors, ThrowOnError>({ url: '/api/v1/organizations/http-integration-cache-policy', ...options });

/**
 * Put Http Integration Cache Policy
 *
 * Persist draft HTTP integration cache preferences for the selected org (runtime cache still off).
 */
export const putHttpIntegrationCachePolicyApiV1OrganizationsHttpIntegrationCachePolicyPut = <ThrowOnError extends boolean = false>(options: Options<PutHttpIntegrationCachePolicyApiV1OrganizationsHttpIntegrationCachePolicyPutData, ThrowOnError>) => (options.client ?? client).put<PutHttpIntegrationCachePolicyApiV1OrganizationsHttpIntegrationCachePolicyPutResponses, PutHttpIntegrationCachePolicyApiV1OrganizationsHttpIntegrationCachePolicyPutErrors, ThrowOnError>({
...
/**
 * Create Quick Persona Test Session
 *
 ...
 */
export const createQuickPersonaTestSessionApiV1LooptalkTestSessionsQuickPersonaPost = <ThrowOnError extends boolean = false>(options: Options<CreateQuickPersonaTestSessionApiV1LooptalkTestSessionsQuickPersonaPostData, ThrowOnError>) => (options.client ?? client).post<CreateQuickPersonaTestSessionApiV1LooptalkTestSessionsQuickPersonaPostResponses, CreateQuickPersonaTestSessionApiV1LooptalkTestSessionsQuickPersonaPostErrors, ThrowOnError>({
...
/**
 * Get Org Weekly Usage Rollup
 *
 * Server-side UTC week aggregates for all workflows in the selected organization.
 */
export const getOrgWeeklyUsageRollupApiV1OrganizationsUsageWeeklyRollupGet = <ThrowOnError extends boolean = false>(options?: Options<GetOrgWeeklyUsageRollupApiV1OrganizationsUsageWeeklyRollupGetData, ThrowOnError>) => (options?.client ?? client).get<GetOrgWeeklyUsageRollupApiV1OrganizationsUsageWeeklyRollupGetResponses, GetOrgWeeklyUsageRollupApiV1OrganizationsUsageWeeklyRollupGetErrors, ThrowOnError>({ url: '/api/v1/organizations/usage/weekly-rollup', ...options });

/**
 * Get Org Daily Usage Rollup
 *
 * Server-side UTC **day** aggregates for all workflows in the selected organization.
 */
export const getOrgDailyUsageRollupApiV1OrganizationsUsageDailyRollupGet = <ThrowOnError extends boolean = false>(options?: Options<GetOrgDailyUsageRollupApiV1OrganizationsUsageDailyRollupGetData, ThrowOnError>) => (options?.client ?? client).get<GetOrgDailyUsageRollupApiV1OrganizationsUsageDailyRollupGetResponses, GetOrgDailyUsageRollupApiV1OrganizationsUsageDailyRollupGetErrors, ThrowOnError>({ url: '/api/v1/organizations/usage/daily-rollup', ...options });
 ...
 * Get Config
 */
export const getConfigApiV1LocalSchedulingConfigGet = <ThrowOnError extends boolean = false>(options?: Options<GetConfigApiV1LocalSchedulingConfigGetData, ThrowOnError>) => (options?.client ?? client).get<GetConfigApiV1LocalSchedulingConfigGetResponses, GetConfigApiV1LocalSchedulingConfigGetErrors, ThrowOnError>({ url: '/api/v1/local-scheduling/config', ...options });

/**
 * List Appointments
 */
export const listAppointmentsApiV1LocalSchedulingAppointmentsGet = <ThrowOnError extends boolean = false>(options?: Options<ListAppointmentsApiV1LocalSchedulingAppointmentsGetData, ThrowOnError>) => (options?.client ?? client).get<ListAppointmentsApiV1LocalSchedulingAppointmentsGetResponses, ListAppointmentsApiV1LocalSchedulingAppointmentsGetErrors, ThrowOnError>({ url: '/api/v1/local-scheduling/appointments', ...options });
 ...
 */
export const createAppointmentApiV1LocalSchedulingAppointmentsPost = <ThrowOnError extends boolean = false>(options: Options<CreateAppointmentApiV1LocalSchedulingAppointmentsPostData, ThrowOnError>) => (options.client ?? client).post<CreateAppointmentApiV1LocalSchedulingAppointmentsPostResponses, CreateAppointmentApiV1LocalSchedulingAppointmentsPostErrors, ThrowOnError>({
 ...
 * Cancel Appointment
 */
export const cancelAppointmentApiV1LocalSchedulingAppointmentsAppointmentIdDelete = <ThrowOnError extends boolean = false>(options: Options<CancelAppointmentApiV1LocalSchedulingAppointmentsAppointmentIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<CancelAppointmentApiV1LocalSchedulingAppointmentsAppointmentIdDeleteResponses, CancelAppointmentApiV1LocalSchedulingAppointmentsAppointmentIdDeleteErrors, ThrowOnError>({ url: '/api/v1/local-scheduling/appointments/{appointment_id}', ...options });
 ...
 */
export const lookupAvailabilityApiV1LocalSchedulingLookupAvailabilityGet = <ThrowOnError extends boolean = false>(options: Options<LookupAvailabilityApiV1LocalSchedulingLookupAvailabilityGetData, ThrowOnError>) => (options.client ?? client).get<LookupAvailabilityApiV1LocalSchedulingLookupAvailabilityGetResponses, LookupAvailabilityApiV1LocalSchedulingLookupAvailabilityGetErrors, ThrowOnError>({ url: '/api/v1/local-scheduling/lookup_availability', ...options });
 ...
 */
export const bookSlotApiV1LocalSchedulingBookSlotPost = <ThrowOnError extends boolean = false>(options: Options<BookSlotApiV1LocalSchedulingBookSlotPostData, ThrowOnError>) => (options.client ?? client).post<BookSlotApiV1LocalSchedulingBookSlotPostResponses, BookSlotApiV1LocalSchedulingBookSlotPostErrors, ThrowOnError>({
