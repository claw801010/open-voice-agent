...
/**
 * Install workflow from catalog pack into the caller's organization
 */
 ...
 * Quick Persona Try
 *
 * Create a LoopTalk session: actor = workflow under test, adversary = system simulated caller.
 */
 ...
 *
 * Server-side UTC calendar-day aggregates for all workflows in the selected organization.
 */
