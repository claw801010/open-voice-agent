...
echo "Incomplete: MK-01-SHIP-PR (commit/PR) · MK-01-VOICE-SPOKEN (ElevenLabs)."
echo "Live capture (optional): ./scripts/gtm_live_capture_ready.sh --run-capture"
echo "Spoken voice (optional): ELEVENLABS_API_KEY=… ./scripts/regen_catalog_voice_previews.sh"
